...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RusticiSoftwareCloudV2.ResponseError();
  });
  ...
  describe('ResponseError', function() {
    it('should create an instance of ResponseError', function() {
      ...
      //var instane = new RusticiSoftwareCloudV2.ResponseError();
      //expect(instance).to.be.a(RusticiSoftwareCloudV2.ResponseError);
    });
