...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RusticiSoftwareCloudV2.ApplicationToken();
  });
  ...
  describe('ApplicationToken', function() {
    it('should create an instance of ApplicationToken', function() {
      // uncomment below and update the code to test ApplicationToken
      //var instane = new RusticiSoftwareCloudV2.ApplicationToken();
      //expect(instance).to.be.a(RusticiSoftwareCloudV2.ApplicationToken);
    });
