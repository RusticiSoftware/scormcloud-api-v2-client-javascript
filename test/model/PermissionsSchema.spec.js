...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RusticiSoftwareCloudV2.PermissionsSchema();
  });
  ...
  describe('PermissionsSchema', function() {
    it('should create an instance of PermissionsSchema', function() {
      // uncomment below and update the code to test PermissionsSchema
      //var instane = new RusticiSoftwareCloudV2.PermissionsSchema();
      //expect(instance).to.be.a(RusticiSoftwareCloudV2.PermissionsSchema);
    });
