...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} scope Space separated string of OAuth scopes, e.g. \"write:course read:registration\". 
     * @param {Object} opts Optional parameters
     * @param {Number} opts.expiration Amount of seconds until the OAuth token expires.  (default to 300)
