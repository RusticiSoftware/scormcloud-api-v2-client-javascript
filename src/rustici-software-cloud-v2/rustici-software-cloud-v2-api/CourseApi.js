...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['rustici-software-cloud-v2/ApiClient', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/MessageSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/LaunchLinkSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/LaunchLinkRequestSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/StringResultSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportFetchRequestSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ResponseError', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/SettingListSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/XapiStatementResult', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseListNonPagedSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseListSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportResultSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/SettingsPostSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/TitleSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../rustici-software-cloud-v2-model/MessageSchema'), require('../rustici-software-cloud-v2-model/LaunchLinkSchema'), require('../rustici-software-cloud-v2-model/LaunchLinkRequestSchema'), require('../rustici-software-cloud-v2-model/StringResultSchema'), require('../rustici-software-cloud-v2-model/ImportFetchRequestSchema'), require('../rustici-software-cloud-v2-model/ResponseError'), require('../rustici-software-cloud-v2-model/CourseSchema'), require('../rustici-software-cloud-v2-model/SettingListSchema'), require('../rustici-software-cloud-v2-model/XapiStatementResult'), require('../rustici-software-cloud-v2-model/CourseListNonPagedSchema'), require('../rustici-software-cloud-v2-model/CourseListSchema'), require('../rustici-software-cloud-v2-model/ImportResultSchema'), require('../rustici-software-cloud-v2-model/SettingsPostSchema'), require('../rustici-software-cloud-v2-model/TitleSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.RusticiSoftwareCloudV2) {
      root.RusticiSoftwareCloudV2 = {};
    }
    root.RusticiSoftwareCloudV2.CourseApi = factory(root.RusticiSoftwareCloudV2.ApiClient, root.RusticiSoftwareCloudV2.MessageSchema, root.RusticiSoftwareCloudV2.LaunchLinkSchema, root.RusticiSoftwareCloudV2.LaunchLinkRequestSchema, root.RusticiSoftwareCloudV2.StringResultSchema, root.RusticiSoftwareCloudV2.ImportFetchRequestSchema, root.RusticiSoftwareCloudV2.ResponseError, root.RusticiSoftwareCloudV2.CourseSchema, root.RusticiSoftwareCloudV2.SettingListSchema, root.RusticiSoftwareCloudV2.XapiStatementResult, root.RusticiSoftwareCloudV2.CourseListNonPagedSchema, root.RusticiSoftwareCloudV2.CourseListSchema, root.RusticiSoftwareCloudV2.ImportResultSchema, root.RusticiSoftwareCloudV2.SettingsPostSchema, root.RusticiSoftwareCloudV2.TitleSchema);
  }
}(this, function(ApiClient, MessageSchema, LaunchLinkSchema, LaunchLinkRequestSchema, StringResultSchema, ImportFetchRequestSchema, ResponseError, CourseSchema, SettingListSchema, XapiStatementResult, CourseListNonPagedSchema, CourseListSchema, ImportResultSchema, SettingsPostSchema, TitleSchema) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.buildCoursePreviewLaunchLink = function(courseId, launchLinkRequest, opts, callback) {
      ...
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling buildCoursePreviewLaunchLink";
      }

      // verify the required parameter 'launchLinkRequest' is set
      if (launchLinkRequest == undefined || launchLinkRequest == null) {
        throw "Missing the required parameter 'launchLinkRequest' when calling buildCoursePreviewLaunchLink";
      }
     ...
     * @param {String} courseId 
     * @param {Integer} versionId The course version
     * @param {module:rustici-software-cloud-v2/rustici-software-cloud-v2-model/LaunchLinkRequestSchema} launchLinkRequest 
    ...
    this.buildCoursePreviewLaunchLinkWithVersion = function(courseId, versionId, launchLinkRequest, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling buildCoursePreviewLaunchLinkWithVersion";
      }

      // verify the required parameter 'versionId' is set
      if (versionId == undefined || versionId == null) {
        throw "Missing the required parameter 'versionId' when calling buildCoursePreviewLaunchLinkWithVersion";
      }

      // verify the required parameter 'launchLinkRequest' is set
      if (launchLinkRequest == undefined || launchLinkRequest == null) {
        throw "Missing the required parameter 'launchLinkRequest' when calling buildCoursePreviewLaunchLinkWithVersion";
      }
    ...
    this.createFetchAndImportCourseJob = function(courseId, importRequest, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling createFetchAndImportCourseJob";
      }

      // verify the required parameter 'importRequest' is set
      if (importRequest == undefined || importRequest == null) {
        throw "Missing the required parameter 'importRequest' when calling createFetchAndImportCourseJob";
      }
    ...
    this.createUploadAndImportCourseJob = function(courseId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling createUploadAndImportCourseJob";
      }
    ...
    this.deleteCourseConfigurationSetting = function(courseId, settingId, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling deleteCourseConfigurationSetting";
      }

      // verify the required parameter 'settingId' is set
      if (settingId == undefined || settingId == null) {
        throw "Missing the required parameter 'settingId' when calling deleteCourseConfigurationSetting";
      }
    ...
    this.deleteCourseVersion = function(courseId, versionId, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling deleteCourseVersion";
      }

      // verify the required parameter 'versionId' is set
      if (versionId == undefined || versionId == null) {
        throw "Missing the required parameter 'versionId' when calling deleteCourseVersion";
      }
    ...
    this.deleteCourseVersionConfigurationSetting = function(courseId, versionId, settingId, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling deleteCourseVersionConfigurationSetting";
      }

      // verify the required parameter 'versionId' is set
      if (versionId == undefined || versionId == null) {
        throw "Missing the required parameter 'versionId' when calling deleteCourseVersionConfigurationSetting";
      }

      // verify the required parameter 'settingId' is set
      if (settingId == undefined || settingId == null) {
        throw "Missing the required parameter 'settingId' when calling deleteCourseVersionConfigurationSetting";
      }
    ...
    this.getCourse = function(courseId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling getCourse";
      }
    ...
    this.getCourseConfiguration = function(courseId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling getCourseConfiguration";
      }
    ...
    this.getCourseStatements = function(courseId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling getCourseStatements";
      }
    ...
    this.getCourseVersionConfiguration = function(courseId, versionId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling getCourseVersionConfiguration";
      }

      // verify the required parameter 'versionId' is set
      if (versionId == undefined || versionId == null) {
        throw "Missing the required parameter 'versionId' when calling getCourseVersionConfiguration";
      }
    ...
    this.getCourseVersionInfo = function(courseId, versionId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling getCourseVersionInfo";
      }

      // verify the required parameter 'versionId' is set
      if (versionId == undefined || versionId == null) {
        throw "Missing the required parameter 'versionId' when calling getCourseVersionInfo";
      }
    ...
    this.getCourseVersionStatements = function(courseId, versionId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling getCourseVersionStatements";
      }

      // verify the required parameter 'versionId' is set
      if (versionId == undefined || versionId == null) {
        throw "Missing the required parameter 'versionId' when calling getCourseVersionStatements";
      }
    ...
    this.getCourseVersions = function(courseId, opts, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling getCourseVersions";
      }
    ...
    this.getCourses = function(opts, callback) {
      ...
      var queryParams = {
        ...
        'includeRegistrationCount': opts['includeRegistrationCount'],
        'includeCourseMetadata': opts['includeCourseMetadata'],
        'tags': this.apiClient.buildCollectionParam(opts['tags'], 'ssv')
      };
      var headerParams = {
      };
      var formParams = {
     ...
     * @param {String} error Error message, if any.
     * @param {module:rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportResultSchema} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportResultSchema}
     */
    this.getImportJobStatus = function(importJobId, callback) {
      ...
      if (importJobId == undefined || importJobId == null) {
        throw "Missing the required parameter 'importJobId' when calling getImportJobStatus";
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = ImportResultSchema;
    ...
    this.setCourseConfiguration = function(courseId, configurationSettings, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling setCourseConfiguration";
      }

      // verify the required parameter 'configurationSettings' is set
      if (configurationSettings == undefined || configurationSettings == null) {
        throw "Missing the required parameter 'configurationSettings' when calling setCourseConfiguration";
      }
    ...
    this.setCourseTitle = function(courseId, title, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling setCourseTitle";
      }

      // verify the required parameter 'title' is set
      if (title == undefined || title == null) {
        throw "Missing the required parameter 'title' when calling setCourseTitle";
      }
    ...
    this.setCourseVersionConfiguration = function(courseId, versionId, configurationSettings, callback) {
      ...
      // verify the required parameter 'courseId' is set
      if (courseId == undefined || courseId == null) {
        throw "Missing the required parameter 'courseId' when calling setCourseVersionConfiguration";
      }

      // verify the required parameter 'versionId' is set
      if (versionId == undefined || versionId == null) {
        throw "Missing the required parameter 'versionId' when calling setCourseVersionConfiguration";
      }

      // verify the required parameter 'configurationSettings' is set
      if (configurationSettings == undefined || configurationSettings == null) {
        throw "Missing the required parameter 'configurationSettings' when calling setCourseVersionConfiguration";
      }
