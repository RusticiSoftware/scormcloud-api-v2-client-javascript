...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['rustici-software-cloud-v2/ApiClient', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseListNonPagedSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseListSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseTagsBatchSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportFetchRequestSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportJobResultSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/LaunchLinkRequestSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/LaunchLinkSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/MessageSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ResponseError', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/SettingListSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/SettingsPostSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/StringResultSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/TagListSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/TitleSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/XapiStatementResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../rustici-software-cloud-v2-model/CourseListNonPagedSchema'), require('../rustici-software-cloud-v2-model/CourseListSchema'), require('../rustici-software-cloud-v2-model/CourseSchema'), require('../rustici-software-cloud-v2-model/CourseTagsBatchSchema'), require('../rustici-software-cloud-v2-model/ImportFetchRequestSchema'), require('../rustici-software-cloud-v2-model/ImportJobResultSchema'), require('../rustici-software-cloud-v2-model/LaunchLinkRequestSchema'), require('../rustici-software-cloud-v2-model/LaunchLinkSchema'), require('../rustici-software-cloud-v2-model/MessageSchema'), require('../rustici-software-cloud-v2-model/ResponseError'), require('../rustici-software-cloud-v2-model/SettingListSchema'), require('../rustici-software-cloud-v2-model/SettingsPostSchema'), require('../rustici-software-cloud-v2-model/StringResultSchema'), require('../rustici-software-cloud-v2-model/TagListSchema'), require('../rustici-software-cloud-v2-model/TitleSchema'), require('../rustici-software-cloud-v2-model/XapiStatementResult'));
  } else {
    // Browser globals (root is window)
    if (!root.RusticiSoftwareCloudV2) {
      root.RusticiSoftwareCloudV2 = {};
    }
    root.RusticiSoftwareCloudV2.CourseApi = factory(root.RusticiSoftwareCloudV2.ApiClient, root.RusticiSoftwareCloudV2.CourseListNonPagedSchema, root.RusticiSoftwareCloudV2.CourseListSchema, root.RusticiSoftwareCloudV2.CourseSchema, root.RusticiSoftwareCloudV2.CourseTagsBatchSchema, root.RusticiSoftwareCloudV2.ImportFetchRequestSchema, root.RusticiSoftwareCloudV2.ImportJobResultSchema, root.RusticiSoftwareCloudV2.LaunchLinkRequestSchema, root.RusticiSoftwareCloudV2.LaunchLinkSchema, root.RusticiSoftwareCloudV2.MessageSchema, root.RusticiSoftwareCloudV2.ResponseError, root.RusticiSoftwareCloudV2.SettingListSchema, root.RusticiSoftwareCloudV2.SettingsPostSchema, root.RusticiSoftwareCloudV2.StringResultSchema, root.RusticiSoftwareCloudV2.TagListSchema, root.RusticiSoftwareCloudV2.TitleSchema, root.RusticiSoftwareCloudV2.XapiStatementResult);
  }
}(this, function(ApiClient, CourseListNonPagedSchema, CourseListSchema, CourseSchema, CourseTagsBatchSchema, ImportFetchRequestSchema, ImportJobResultSchema, LaunchLinkRequestSchema, LaunchLinkSchema, MessageSchema, ResponseError, SettingListSchema, SettingsPostSchema, StringResultSchema, TagListSchema, TitleSchema, XapiStatementResult) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:rustici-software-cloud-v2/rustici-software-cloud-v2-model/CourseTagsBatchSchema} batch 
