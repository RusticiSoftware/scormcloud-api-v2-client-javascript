...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['rustici-software-cloud-v2/ApiClient', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportConnectorRequestSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportFetchRequestSchema', 'rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportMediaFileReferenceRequestSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ImportConnectorRequestSchema'), require('./ImportFetchRequestSchema'), require('./ImportMediaFileReferenceRequestSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.RusticiSoftwareCloudV2) {
      root.RusticiSoftwareCloudV2 = {};
    }
    root.RusticiSoftwareCloudV2.ImportRequestSchema = factory(root.RusticiSoftwareCloudV2.ApiClient, root.RusticiSoftwareCloudV2.ImportConnectorRequestSchema, root.RusticiSoftwareCloudV2.ImportFetchRequestSchema, root.RusticiSoftwareCloudV2.ImportMediaFileReferenceRequestSchema);
  }
}(this, function(ApiClient, ImportConnectorRequestSchema, ImportFetchRequestSchema, ImportMediaFileReferenceRequestSchema) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('connectorReferenceRequest'))
        obj.connectorReferenceRequest = ImportConnectorRequestSchema.constructFromObject(data['connectorReferenceRequest']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:rustici-software-cloud-v2/rustici-software-cloud-v2-model/ImportConnectorRequestSchema} connectorReferenceRequest
   */
  exports.prototype.connectorReferenceRequest = undefined;
